...
const MoonOrSun = styled.div`
  ...
  &::after {
    border-radius: 50%;
    box-shadow: 0 -23px 0 var(--gray-light-color),
      0 23px 0 var(--gray-light-color),
      23px 0 0 var(--gray-light-color),
      -23px 0 0 var(--gray-light-color),
      15px 15px 0 var(--gray-light-color),
      -15px 15px 0 var(--gray-light-color),
      15px -15px 0 var(--gray-light-color),
      -15px -15px 0 var(--gray-light-color);
    content: "";
...
export function DarkModeToggle() {
  const { isDark, toggleDarkMode } = React.useContext(StateContext)
